...
describe('When parsing file info', () => {
    test(`and the file info is typical`, () => {
        let file = fileParser.parseFile(`<eb:Reference eb:id="_72FA3D52-D2B2-4197-87F4-238E9C6E4AA7" xlink:href="cid:Attachment1@e-mis.com/EMISWeb/GP2GP2.2A" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        expect(file).toEqual({
            ...
            fileLength: 72580,
            id: 'cid:Attachment1@e-mis.com/EMISWeb/GP2GP2.2A'
        });
    });

    test(`and the file info contains meta data after the Length setting`, () => {
        let file = fileParser.parseFile(`<eb:Reference eb:id="_857419DE-7512-4619-A567-067CF9959EF1" xlink:href="cid:Attachment2@e-mis.com/EMISWeb/GP2GP2.2A" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        expect(file).toEqual({
            ...
            largeAttachment: false,
            fileLength: 723420,
            id: 'cid:Attachment2@e-mis.com/EMISWeb/GP2GP2.2A'
        });
    });

    test(`and filename contains meta data that might confuse our Length parsing`, () => {
        let file = fileParser.parseFile(`<eb:Reference eb:id="_3D085A2B-E00F-44F8-AA85-6699D2D4B259" xlink:href="mid:E5EE718C-2577-401B-AFC3-CB651FD3011F" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        expect(file).toEqual({
            ...
            fileLength: 42810092,
            id: 'mid:E5EE718C-2577-401B-AFC3-CB651FD3011F'
        });
    });
});